      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-32">
        <div className="text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A mathematically-proven infrastructure where capacity flows automatically to what you value most - enabling any entity, from individuals to institutions, to coordinate resources in alignment with their priorities/needs.
          </p>
